...
exports.getAllDoctors = async (req, res, next) => {
  try {
    ...
    // Client-side search filter by name (after populate)
    ...
    return paginate(res, filtered, total, page, limit);
  } catch (err) {
    next(err);
  }
};
...
exports.updateProfile = async (req, res, next) => {
  try {
    const allowedFields = ['bio', 'experience', 'price', 'languages', 'availability', 'hospital', 'qualification', 'specialization', 'regNo'];
    const updates = {};
