...
const PATIENT_NAV_ITEMS = [
  { page: PAGES.DASHBOARD, label: "Dashboard", mobileLabel: "Home", icon: GridIcon },
  { page: PAGES.DOCTORS, label: "Consult Doctor", mobileLabel: "Doctors", icon: UserIcon },
  { page: PAGES.CONSULTATION_LIST, label: "Consultations", mobileLabel: "Chats", icon: MessageIcon },
  { page: PAGES.PRESCRIPTION_LIST, label: "Prescriptions", mobileLabel: "Rx", icon: FileIcon },
  { page: PAGES.RECORDS, label: "Health Records", mobileLabel: "Records", icon: PlusSquareIcon },
  { page: PAGES.ORDERS, label: "Orders", icon: BoxIcon },
];

const DOCTOR_NAV_ITEMS = [
  { page: PAGES.DOCTOR_DASHBOARD, label: "Dashboard", mobileLabel: "Home", icon: GridIcon },
  { page: PAGES.CREATE_PRESCRIPTION, label: "New Prescription", mobileLabel: "New Rx", icon: PlusIcon },
  { page: PAGES.DOCTOR_PRESCRIPTIONS, label: "My Prescriptions", mobileLabel: "Rx", icon: FileIcon },
  { page: PAGES.CONSULTATION, label: "Consultations", mobileLabel: "Chats", icon: MessageIcon },
];

const ADMIN_NAV_ITEMS = [
  { page: PAGES.ADMIN_DASHBOARD, label: "Admin Panel", mobileLabel: "Admin", icon: GridIcon },
];
